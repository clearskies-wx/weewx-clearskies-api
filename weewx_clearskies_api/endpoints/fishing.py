...
# ---------------------------------------------------------------------------
# Marine unit resolution — see endpoints/surf.py for the rationale (marine
# groups are not enumerated in services/units.py's _GROUP_MEMBERS yet).
# ---------------------------------------------------------------------------
...
def _units_block() -> dict[str, str]:
    ...
    return {
        ...
        "swellPeriod": _WAVE_PERIOD_UNIT[1],
